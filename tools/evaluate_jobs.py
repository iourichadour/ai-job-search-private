#!/usr/bin/env python3
"""
Job Evaluation using Claude AI.
...
Setup:
  ...
  3. Run: python tools/evaluate_jobs.py
"""
...
try:
    ...
    print("[!] Anthropic SDK not installed. Run:")
...
if not api_key:
    ...
    print("  Mac/Linux: export ANTHROPIC_API_KEY=your-api-key")
    sys.exit(1)
...
def evaluate_job(job_data, profile):
    """
    Evaluate a job posting using Claude.
...
def main():
    ...
    for i, job in enumerate(jobs_to_evaluate, 1):
        ...
        print(f"    [→] Evaluating with Claude...")
