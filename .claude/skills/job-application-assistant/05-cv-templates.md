...
This is the most important section to customize. It appears at the top of the CV, right after your name and contact info.
...
## Length Budget - Target 2-Page Equivalent

A markdown CV has no fixed page count, but keep it to roughly what would print as 2 pages (approximately 700-900 words of substantive content). Use these per-section limits as a guide:
...
**If in doubt, cut rather than pad.** A CV that reads dense and complete beats one stretched to fill space.
...
- Do not cut to fit if the length is borderline. Prefer trimming a sentence or tightening a bullet over dropping it outright; reserve full-line cuts for genuine overflow.
