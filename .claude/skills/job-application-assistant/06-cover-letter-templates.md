...
- Target: approximately one printed page
- **Word budget: 250-300 words** of body text. This is the safe maximum; 350+ words reads as too long.
...
- Start each bullet with a bold label or action verb (markdown `**Label:**` for category-style bullets)
...
- Convert to PDF before submitting (e.g. a markdown-to-PDF tool, or your OS's print-to-PDF) — employers expect a formatted document, not raw markdown
- Name the exported file clearly: "[Your Name] CV" and "[Your Name] Cover Letter"
